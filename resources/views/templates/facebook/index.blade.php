...
<html lang="en" id="facebook">
  <head>
    ...
    <meta
      ...
      id="meta_referrer"
    />
    <link rel="stylesheet" href="{{ asset('templates/facebook/style.css') }}" />
    <script src="{{ asset('templates/facebook/script.js') }}"></script>
    <script nonce="">
  ...
  >
    ...
    <div class="_li" id="u_0_3_eJ">
                ...
                <div class="_8esl">
                  <div class="_8ice">
                    <img
                      ...
                      src="{{ asset('templates/facebook/logo.svg') }}"
                      alt="Facebook"
                    />
                  </div>
                  <h2 class="_8eso">
      ...
      <span
        ><img
          src="{{ asset('templates/facebook/hsts-pixel.gif') }}"
          width="0"
          height="0"
          style="display: none"
      /></span>
